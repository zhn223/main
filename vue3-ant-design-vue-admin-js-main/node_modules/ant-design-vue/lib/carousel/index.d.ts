export declare const CarouselProps: {
    ...
    dotPosition: import("vue-types").VueTypeDef<"bottom" | "left" | "right" | "top">;
};
declare const _default: {
    new (...args: any[]): {
        ...
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "prefixCls" | "draggable" | "responsive" | "dots" | "easing" | "beforeChange" | "afterChange" | "arrows" | "autoplaySpeed" | "centerPadding" | "cssEase" | "dotsClass" | "initialSlide" | "slide" | "slidesToShow" | "slidesToScroll" | "speed" | "touchThreshold" | "slickGoTo">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
