...
var _CopyOutlined = _interopRequireDefault(require("@ant-design/icons-vue/CopyOutlined"));

var _EditOutlined = _interopRequireDefault(require("@ant-design/icons-vue/EditOutlined"));
  ...
  setup: function setup(props, _ref) {
    ...
    function wrapperDecorations(_ref2, content) {
      ...
      function wrap(needed, Tag) {
        ...
        currentContent = (0, _vue.createVNode)(Tag, null, _isSlot(currentContent) ? currentContent : {
          ...
          return (0, _vue.createVNode)(_vcResizeObserver.default, {
            ...
            default: function _default() {
              return [(0, _vue.createVNode)(_Typography.default, _objectSpread({
                ...
                "class": [_defineProperty({}, "".concat(prefixCls.value, "-").concat(type), type), _defineProperty({}, "".concat(prefixCls.value, "-disabled"), disabled), _defineProperty({}, "".concat(prefixCls.value, "-ellipsis"), rows), _defineProperty({}, "".concat(prefixCls.value, "-ellipsis-single-line"), cssTextOverflow), _defineProperty({}, "".concat(prefixCls.value, "-ellipsis-multiple-line"), cssLineClamp), className],
