import { CSSProperties, VNode, Plugin } from 'vue';
...
declare const _default: {
    new (...args: any[]): {
        ...
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "title" | "prefixCls" | "color" | "overflowCount" | "scrollNumberPrefixCls">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $options: import("vue").ComponentOptionsBase<Readonly<{
            ...
            getBadgeClassName(prefixCls: string, children: VNode<import("vue").RendererNode, import("vue").RendererElement, {
                [key: string]: any;
            }>[]): string;
            hasStatus(): boolean;
            isZero(): boolean;
